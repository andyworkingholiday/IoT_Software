...
const int FndFont[11]={0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07,0x7F, 0x67, 0x80};
...
int main() {
	...
	while(1) {
		...
		if(times >=1000) FndDisplay(4,d4);
		if(times >=10000) FndDisplay(5,d5);
